...
步骤： 1、重启Linux，鼠标单击启动界面，按键盘上下键使启动界面暂停 2、按键盘E键，光标往下选中kernel这行，再次按E键 3、按空格键，然后在后面添加数字1，回车 4、按B键启动系统 5、在命令行输入 \#passwd,回车，输入两遍新密码 6、在命令行输入 \#init 5
