...
date: '2017-08-25T23:55:43.000Z'
categories: Linux
comments: true
---

# linux从入门到放弃—08Can't login
...
载转[Ubuntu Linux 环境变量PATH设置](https://blog.csdn.net/witsmakemen/article/details/7831631) linux系统环境变量配置文件：
