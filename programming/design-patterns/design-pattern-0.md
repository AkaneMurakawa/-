...
不知道大家有没有这么一个习惯，平时的话可能不会定期去整理东西，但是一旦觉得很乱的时候😩，就会忍不住去整理。这个时候问题来了，东西该从哪里开始整理呢？🤔_this's a question._
...
学习设计模式，主要分为两点，第一是了解其原则，遵守设计模式制定的一些规范；第二是学习一些`设计思想`，这些设计思想就是用于解决特定的问题。 专业术语上我们把这两点称之为：设计模式七大原则、23种设计模式。下面的内容可以先简单了解。
